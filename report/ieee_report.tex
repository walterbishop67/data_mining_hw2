...
The final dataset used by the system contains 23,061 articles with usable abstracts, 455 journals, and 80 distinct subject areas. The TF-IDF representation contains up to 80,000 features after applying English stop-word filtering and document frequency controls.
...
\item SOFTWARE TESTING VERIFICATION \& RELIABILITY
\end{enumerate}
